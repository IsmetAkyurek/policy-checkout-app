 ...
 */
const useGet = <U>(action: Action<U>, options?: UseGetOptions): UseGetResponse<U> => {
  ...
  return { data, request, loading: state.loading, error: state.error };
};
